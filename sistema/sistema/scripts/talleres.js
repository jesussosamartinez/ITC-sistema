...
function guardaryeditar(e)
{
	...
	var actividad="Tipo de actividad: "+ $("#tipo_actividad").val() + " Tipo de taller: "+ $("#Tipo").val() ;
	...
	$.ajax({
	    ...
	    {         
			registrarEnBitacora( "Registro de actividad correcto",actividad, function(success) {
				if (success) {
...
function registrarEnBitacora(estatus,actividad, callback) {
	$.post("../ajax/Bitacora.php?op=RegistroActividad", {
		"Movimiento": "Registro de 	Actividad",
		"Estatus": estatus,
		"Actividad": actividad
	}, function(data) {
		callback(data != "null");
