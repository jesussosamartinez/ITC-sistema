    ...
    switch ($_GET["op"]) {
       ...
       case 'acceso':
        ...
        case 'accesos_alumnos':
            ...
            // Datos a encriptar
            $data = $Password;
            // Clave para el cifrado (asegúrate de guardarla de forma segura)
            $key = "Clav3";
            ...
            $rspta = $datos->añadir_alumno($NumeroControl,$ApellidoP,$ApellidoM,$Nombre,$Correo,$Semestre,$ClaveCarrera,$Telefono,$Sexo) ." ". $datos->añadir_user($Correo,  $encrypted_data) ;
